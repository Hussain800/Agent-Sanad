...
async def stream_decision(case_id: str, request: Request):
    ...
    async def _event_stream():
        meta = {"case_id": case_id, "request_id": request_id, "mock_mode": MOCK_MODE}
...
def decision_history():
    ...
    decisions = []
    for app_rec in apps:
        full = STORE.get_application(app_rec["id"])
...
def admin_get_policy():
    ...
    return {
        ...
        "note": "Use PUT /admin/policy with the fields you want to change. Changes apply immediately.",
    }
