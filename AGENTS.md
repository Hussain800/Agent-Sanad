...
**431 tests passing** across 45+ test files (v1.8.0).
...
## API endpoints (190 routes — key demo routes below)
...
```
backend/
  app.py              — FastAPI app (190 routes, JSON logger, error envelope)
...
tests/                — 45+ test files (431 passing)
...
- **New test files**: `test_benchmark_replay.py` (18 tests), `test_store.py` (12), `test_security.py` (11). Run full suite to verify 431 tests pass.
